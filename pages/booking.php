          ...
          <div class="modal-body">
            ...
            <div class="row" id="sod">
              ...
              <div class="row">
                <div class="col-6">
                  <div class="input-group mb-3">
                    ...
                    <input type="number" min="0" max="999" value="0" id="desktopMicrophone" name="desktopMicrophone" class="form-control">
                ...
                <div class="col-6">
                  <div class="input-group mb-3">
                    <span class="input-group-text">ไมโครโฟนชนิดตั้งพื้นจำนวน</span>
                     <input type="number" min="0" max="999" value="0" id="floorMicrophone" name="floorMicrophone" class="form-control">
                    <span class="input-group-text">ตัว</span>
                  </div>
                </div>
              </div>
                ...
                <div class="col-6">
                  <div class="input-group mb-3">
                    <span class="input-group-text">ไมโครโฟนชนิดไร้สายจำนวน</span>
                     <input type="number" min="0" max="999" value="0" id="wirelessMicrophone" name="wirelessMicrophone" class="form-control">
                    <span class="input-group-text">ตัว</span>
                  </div>
                </div>
                <div class="col-6">
              ...
              <div class="row">
                <div class="col-6">
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="presentByComputer" name="presentByComputer" id="presentByComputer">
                ...
                <div class="col-6">
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="visualizer" name="visualizer" id="visualizer">
              ...
              <div class="row">
                <div class="col-6">
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="visualizer3D" name="visualizer3D" id="visualizer3D">
                ...
                <div class="col-6">
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="videoPlayer" name="videoPlayer" id="videoPlayer">
              ...
              <div class="row">
                <div class="col-6">
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="takingPictures" name="takingPictures" id="takingPictures">
                ...
                <div class="col-6">
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="VdoRecord" name="VdoRecord" id="VdoRecord">
